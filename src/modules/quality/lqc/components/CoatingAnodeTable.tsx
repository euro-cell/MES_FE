...
export default function CoatingAnodeTable({ projectId }: CoatingAnodeTableProps) {
  // 규격 모달 상태
    ...
    <div className={styles.tableContainer}>
      ...
      <div className={styles.tableSection}>
        <div className={styles.tableTitleRow}>
          <h3 className={styles.tableTitle}>Coating 전극 검사 (음극)</h3>
          ...
          <table className={styles.lqcTable}>
            ...
            <tbody>
              ...
              <tr className={`${styles.summaryRow} ${styles.avgRow}`}>
                <td colSpan={3}>Ave.</td>
                <td>{formatNumber(stats.singleSideAvg.avg)}</td>
              ...
              <tr className={`${styles.summaryRow} ${styles.maxRow}`}>
                <td colSpan={3}>Max.</td>
                <td>{formatNumber(stats.singleSideAvg.max)}</td>
              ...
              <tr className={`${styles.summaryRow} ${styles.minRow}`}>
                <td colSpan={3}>Min.</td>
                <td>{formatNumber(stats.singleSideAvg.min)}</td>
              ...
              <tr className={`${styles.summaryRow} ${styles.stdevRow}`}>
                ...
                <td>{formatNumber(stats.singleSideAvg.stdev, 3)}</td>
              ...
              {hasData ? (
                coatingData.map((row, index) => (
                  <tr key={`${row.id}-${index}`}>
                    ...
                    <td>{row.lot}</td>
                    <td>{row.division}</td>
                    <td>{formatNumber(calcRowAvg(row.singleSideTop, row.singleSideMiddle, row.singleSideBottom))}</td>
