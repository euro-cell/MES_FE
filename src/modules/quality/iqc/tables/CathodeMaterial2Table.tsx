...
import type { CathodeMaterial2Data } from '../IQCTypes';

interface CathodeMaterial2TableProps {
  data?: CathodeMaterial2Data;
}

const CathodeMaterial2Table: React.FC<CathodeMaterial2TableProps> = ({
  data,
}) => {
  if (!data) {
    return (
    ...
    <div className={styles.tableContainer}>
      ...
      <div className={styles.tableSection}>
        <div className={styles.tableTitleRow}>
          <h3 className={styles.tableTitle}>양극재2 (LCO) 검사</h3>
        </div>
