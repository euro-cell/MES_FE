...
import type { ConductiveMaterialData } from '../IQCTypes';

interface ConductiveMaterialTableProps {
  data?: ConductiveMaterialData;
}

const ConductiveMaterialTable: React.FC<ConductiveMaterialTableProps> = ({
  data,
}) => {
  if (!data) {
    return (
    ...
    <div className={styles.tableContainer}>
      ...
      <div className={styles.tableSection}>
        <div className={styles.tableTitleRow}>
          <h3 className={styles.tableTitle}>도전재 (Carbon black) 검사</h3>
        </div>
