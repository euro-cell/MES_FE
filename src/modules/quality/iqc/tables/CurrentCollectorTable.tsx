...
import type { CurrentCollectorData } from '../IQCTypes';

interface CurrentCollectorTableProps {
  data?: CurrentCollectorData;
}

const CurrentCollectorTable: React.FC<CurrentCollectorTableProps> = ({
  data,
}) => {
  if (!data) {
    return (
    ...
    <div className={styles.tableContainer}>
      ...
      <div className={styles.tableSection}>
        <div className={styles.tableTitleRow}>
          <h3 className={styles.tableTitle}>집전체 (Al-foil) 검사</h3>
        </div>
