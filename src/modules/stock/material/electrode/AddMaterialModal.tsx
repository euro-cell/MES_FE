        ...
        <form onSubmit={onSubmit} className={styles.modalForm}>
          <div className={styles.formRow}>
            <div className={styles.formGroup}>
              <label>분류 (중분류)</label>
              <select name='category' value={formData.category} onChange={onFormChange} required disabled={isEditing}>
          ...
          <div className={styles.formRow}>
            <div className={styles.formGroup}>
              <label>용도</label>
              <select name='purpose' value={formData.purpose} onChange={onFormChange} required>
                <option value=''>선택</option>
          ...
          <div className={styles.formRow}>
            <div className={styles.formGroup}>
              <label>규격</label>
              <textarea name='spec' value={formData.spec} onChange={onFormChange} placeholder='규격 정보' rows={2} />
            </div>
          </div>
          ...
          <div className={styles.formRow}>
            <div className={styles.formGroup}>
              <label>국내/해외</label>
              <select name='origin' value={formData.origin} onChange={onFormChange}>
          ...
          <div className={styles.formRow}>
            <div className={styles.formGroup}>
              <label>비고</label>
              <input type='text' name='note' value={formData.note} onChange={onFormChange} placeholder='비고' />
            </div>
          </div>
