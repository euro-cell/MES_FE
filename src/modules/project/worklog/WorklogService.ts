...
/** 특정 프로젝트+공정의 작업일지 조회 */
export const getWorklogs = async (_projectId: number, _processId: string): Promise<WorklogEntry[]> => {
  // TODO: 백엔드 API 구현 시 활성화
...
/** 작업일지 등록 */
export const createWorklog = async (_projectId: number, _payload: WorklogPayload): Promise<WorklogEntry> => {
  // TODO: 백엔드 API 구현 시 활성화
...
/** 작업일지 수정 */
export const updateWorklog = async (_worklogId: number, _payload: Partial<WorklogPayload>): Promise<WorklogEntry> => {
  // TODO: 백엔드 API 구현 시 활성화
...
/** 작업일지 삭제 */
export const deleteWorklog = async (_worklogId: number): Promise<void> => {
  // TODO: 백엔드 API 구현 시 활성화
