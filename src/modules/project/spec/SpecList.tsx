                ...
                <td>
                  <div className={styles.actionButtons}>
                    <TooltipButton
                      ...
                      onClick={() => (item.specStatus || item.materialStatus) && navigate(`view/${item.id}`)}
                    />
                  </div>
                </td>
                ...
                <td>
                  <div className={styles.actionButtons}>
                    <TooltipButton
                      ...
                      onClick={() => !item.specStatus && navigate(`new/${item.id}`)}
                    />
                    ...
                    <TooltipButton
                      ...
                      onClick={() => item.specStatus && navigate(`edit/${item.id}`)}
                    />
                ...
                <td>
                  <div className={styles.actionButtons}>
                    <TooltipButton
                      ...
                      tooltip='이미 셀당 소요량이 등록되어 있습니다.'
                      onClick={() => !item.bomStatus && navigate(`bom/new/${item.id}`)}
                    />
                    ...
                    <TooltipButton
                      ...
                      onClick={() => item.bomStatus && navigate(`bom/edit/${item.id}`)}
                    />
                    ...
                    <TooltipButton
                      ...
                      disabled={!item.bomStatus}
                      tooltip='등록된 셀당 소요량이 없습니다.'
                      onClick={() => item.bomStatus && handleBomDelete(item.id, item.name)}
                    />
                  </div>
                </td>
                ...
                <td>
                  <div className={styles.actionButtons}>
                    <TooltipButton
                      ...
                      onClick={() => !item.materialStatus && navigate(`material/new/${item.id}`)}
                    />
                    ...
                    <TooltipButton
                      ...
                      onClick={() => item.materialStatus && navigate(`material/edit/${item.id}`)}
                    />
